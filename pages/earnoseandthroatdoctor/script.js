...
function fetchDoctorsDentistry() {
    dbPromise.then((db) => {
        ...
        const dentistDoctors = doctorObjectStore.index('specialization').getAll("أنف وأذن و حنجرة");
        ...
        doctorCard.innerHTML = `
            <div class="card-doctor mb-3">
                ...
                <div class="info">
                    ...
                    <p class="d-flex review mb-2 ${lang === 'ar' ? 'text-end' : 'text-start'}">${lang === "ar" ? ` التقييم العام من ${doctor.countratings} زاروا الدكتور ` : ` Overall Rating From ${doctor.countratings} Visitors `}</p>
...
document.querySelector(".fixed-width").innerHTML = `
                ...
                <div class="side-bar w-full">
                    ...
                    <!-- Button 3 to toggle menu 3 -->
                    <div class="btn-group">
                        <button id="toggleMenuBtn3">
                            Toggle Menu 3 <i id="arrowIcon3" class="fas fa-chevron-down rotate-icon"></i>
                        </button>
                        <div id="menu3" class="menu">
                            <div class="menu-item">
                                <label>
                                    <input type="checkbox"> Option 3-1
                                </label>
                            </div>
                            <div class="menu-item">
                                <label>
                                    <input type="checkbox"> Option 3-2
                                </label>
                            </div>
                        </div>
                    </div>

                    <!-- Button 4 to toggle menu 4 -->
                    <div class="btn-group">
                        <button id="toggleMenuBtn4">
                            Toggle Menu 4 <i id="arrowIcon4" class="fas fa-chevron-down rotate-icon"></i>
                        </button>
                        <div id="menu4" class="menu">
                            <div class="menu-item">
                                <label>
                                    <input type="checkbox"> Option 4-1
                                </label>
                            </div>
                            <div class="menu-item">
                                <label>
                                    <input type="checkbox"> Option 4-2
                                </label>
                            </div>
                        </div>
                    </div>

                    <!-- Button 5 to toggle menu 5 -->
                    <div class="btn-group">
                        <button id="toggleMenuBtn5">
                            Toggle Menu 5 <i id="arrowIcon5" class="fas fa-chevron-down rotate-icon"></i>
                        </button>
                        <div id="menu5" class="menu">
                            <div class="menu-item">
                                <label>
                                    <input type="checkbox"> Option 5-1
                                </label>
                            </div>
                            <div class="menu-item">
                                <label>
                                    <input type="checkbox"> Option 5-2
                                </label>
                            </div>
                        </div>
                    </div>
